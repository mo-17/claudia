...
export const Settings: React.FC<SettingsProps> = ({
  ...
  const loadSettings = async () => {
    try {
      ...
      setError(t('settings.settingsLoadError'));
      setSettings({});
    } finally {
      setLoading(false);
    }
  ...
  const saveSettings = async () => {
    try {
      ...
      setError(t('settings.settingsSaveError'));
      setToast({ message: t('settings.settingsSaveError'), type: "error" });
    } finally {
      setSaving(false);
    }
  };
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5 flex-1">
                        <Label htmlFor="coauthored">{t('settings.coAuthoredBy')}</Label>
                        <p className="text-xs text-muted-foreground">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5 flex-1">
                        ...
                        <p className="text-xs text-muted-foreground">
                          {t('settings.verboseOutputDescription')}
                        </p>
                      </div>
                      <Switch
                        id="verbose"
                    ...
                    <div className="space-y-2">
                      ...
                      />
                      <p className="text-xs text-muted-foreground">
                        {t('settings.chatRetentionDescription')}
                      </p>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground mb-4">
                          {t('settings.claudeInstallationDescription')}
                        </p>
                      </div>
                    ...
                    <div className="space-y-2">
                      {allowRules.length === 0 ? (
                        ...
                        allowRules.map((rule) => (
                          ...
                          >
                            <Input
                              placeholder={t('settings.allowRulePlaceholder')}
                              value={rule.value}
                    ...
                    <div className="space-y-2">
                      {denyRules.length === 0 ? (
                        ...
                        denyRules.map((rule) => (
                          ...
                          >
                            <Input
                              placeholder={t('settings.denyRulePlaceholder')}
                              value={rule.value}
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mt-1">
                        {t('settings.environmentVariablesDescription')}
                      </p>
                    </div>
                    <Button
                      variant="outline"
              ...
              <Card className="p-6">
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-xs text-muted-foreground">
                      {t('settings.apiKeyHelperDescription')}
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      {t('settings.rawSettingsDescription')}
                    </p>
                  </div>
                </div>
              </Card>
              ...
              <Card className="p-6">
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mb-4">
                      {t('settings.userHooksDescription')}
                    </p>
                  </div>
