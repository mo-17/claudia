...
export const MarkdownEditor: React.FC<MarkdownEditorProps> = ({
  ...
  const loadSystemPrompt = async () => {
    try {
      ...
      setError(t("markdownEditor.errors.loadFailed"));
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleSave = async () => {
    try {
      ...
      setToast({ message: t("markdownEditor.success.saved"), type: "success" });
    } catch (err) {
      console.error("Failed to save system prompt:", err);
      setError(t("markdownEditor.errors.saveFailed"));
      setToast({ message: t("markdownEditor.errors.saveFailed"), type: "error" });
    } finally {
      setSaving(false);
    }
  };
