    ...
    <>
              ...
              >
                {imageErrors.has(index) ? (
                  ...
                  <img
                    ...
                    alt={t('imagePreview.previewAlt', { index: index + 1 })}
      ...
      >
        <DialogContent className="max-w-4xl max-h-[90vh] p-0">
          <DialogTitle className="sr-only">{t('imagePreview.dialogTitle')}</DialogTitle>
          {selectedImageIndex !== null && (
            <div className="relative w-full h-full flex items-center justify-center p-4">
              <img
                src={getImageSrc(displayImages[selectedImageIndex])}
                alt={t('imagePreview.fullPreviewAlt', { index: selectedImageIndex + 1 })}
